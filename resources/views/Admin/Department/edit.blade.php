                        ...
                        <div class="row gx-3">
                            ...
                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('department_name') is-invalid @enderror"
                                            id="department_name" name="department_name" required>
                                        <option value="">Select Department</option>
                                        <option value="BCA" {{ old('department_name', $department->department_name) == 'BCA' ? 'selected' : '' }}>BCA</option>
                                        <option value="BSC IT" {{ old('department_name', $department->department_name) == 'BSC IT' ? 'selected' : '' }}>BSC IT</option>
                                        <option value="MCA" {{ old('department_name', $department->department_name) == 'MCA' ? 'selected' : '' }}>MCA</option>
                                    </select>
