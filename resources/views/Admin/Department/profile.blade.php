                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Department Profile</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('department.view', $department->id ?? '') }}" method="POST">
                                @csrf
                                <div class="row gx-3">
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row gx-3">
                                                    ...
                                                    <!-- Full Name -->
                                                    <input type="hidden" name="full_name" value="{{ $department->department_name ?? '' }}">
                                                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="full_name">Department Name</label>
                                                            <input type="text" class="form-control" id="full_name" value="{{ $department->department_name ?? '' }}" disabled>
                                                        </div>
                                                    </div>

                                                    <div class="col-sm-12 d-flex gap-2 justify-content-end">
                                                        <a href="{{ url('departmentlist') }}" class="btn btn-primary ms-auto">Back</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
