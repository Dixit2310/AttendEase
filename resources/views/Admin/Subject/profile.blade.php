            ...
            <div class="row gx-3">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('subject.view', $subject->subject_id ?? '') }}" method="POST">
                                @csrf
                                <div class="row gx-3">
                                    <div class="col-sm-12">
                                        <div class="card">
                                                ...
                                                <div class="row gx-3">
                                                    ...
                                                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="subject_name" value="{{ $subject->subject_name ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="department" value="{{ $subject->department->department_name ?? '' }}" disabled>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="semester" value="{{ $subject->semester ?? '' }}" disabled>
                                                        </div>
                                                    </div>

                                                    <div class="col-sm-12 d-flex gap-2 justify-content-end">
                                                        <a href="{{ route('subjectlist') }}" class="btn btn-primary ms-auto">Back</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
