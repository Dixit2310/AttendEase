                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="{{ route('subject_add') }}" class="btn btn-primary ms-auto">Add Subject</a>
                                </div>
                                <div class="card-body">
                                                        ...
                                                        <td>
                                                            <div class="d-inline-flex gap-1">
                                                                ...
                                                                <button type="button" class="btn btn-outline-danger btn-sm"
                                                                    ...
                                                                    onclick="setDeleteSubjectId({{ $subject->subject_id }})">
                                                                    <i class="ri-delete-bin-line"></i>
                                                                </button>

                                                                <!-- Edit Button -->
                                                                <a href="{{ route('subject_edit', ['id' => $subject->subject_id]) }}"
                                                                    class="btn btn-outline-success btn-sm">
                                                                    <i class="ri-edit-box-line"></i>
                                                                </a>

                                                                <!-- View Button -->
                                                                <a href="{{ route('subject.view', ['id' => $subject->subject_id]) }}"
