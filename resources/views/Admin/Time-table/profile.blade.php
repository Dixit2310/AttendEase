                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Time-table Profile</h5>
                        </div>
                        <div class="card-body">
                            <form>
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="date" value="{{ $timetable->date }}" disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="division" class="form-label">Division</label>
                                        <input type="text" class="form-control" id="division" value="{{ $timetable->division }}" disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="semester" class="form-label">Semster</label>
                                        <input type="text" class="form-control" id="semester" value="{{ $timetable->semester }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="starttime" value="{{ $timetable->starttime }}" disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="endtime" class="form-label">End Time</label>
                                        <input type="text" class="form-control" id="endtime" value="{{ $timetable->endtime }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="subject" value="{{ $timetable->subject->subject_name ?? '-' }}" disabled>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="faculty" class="form-label">Faculty</label>
                                        <input type="text" class="form-control" id="faculty" value="{{ $timetable->faculty->full_name ?? '-' }}" disabled>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="department" class="form-label">Department</label>
                                        <input type="text" class="form-control" id="department" value="{{ $timetable->department->department_name ?? '-' }}" disabled>
                                    </div>
                                </div>
                                <div class="col-sm-12 d-flex gap-2 justify-content-end">
                                    <a href="{{ route('time-tablelist') }}" class="btn btn-primary ms-auto">Back</a>
                                </div>
                            </form>
                        </div>
                    </div>
