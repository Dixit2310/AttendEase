        ...
        <div class="main-container">
            ...
            <div class="app-container">
                ...
                <div class="app-body">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="card-title">Time-table List</h5>
                                    <a href="{{ url('time-table_add') }}" class="btn btn-primary ms-auto">Add
                                        Time-table</a>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach ($timetables as $timetable)
                                                    <tr>
                                                        ...
                                                        <td>{{ $timetable->department->department_name ?? '-' }}</td>
                                                        <td>{{ $timetable->division }}</td>
                                                        <td>
                                                            <div class="d-inline-flex gap-1">
                                                                <!-- Delete Button -->
                                                                <form action="{{ route('admin.timetable.destroy', $timetable->timetable_id) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                                    @csrf
                                                                ...
                                                                <!-- Edit Button -->
                                                                <a href="{{ route('admin.timetable.edit', $timetable->timetable_id) }}"
                                                                    class="btn btn-outline-success btn-sm">
                                                                    <i class="ri-edit-box-line"></i>
                                                                </a>

                                                                <!-- View Button -->
                                                                <a href="{{ route('admin.timetable.view', $timetable->timetable_id) }}"
                    ...
                    <script>
                        function setDeleteSubjectId(subjectId) {
                            let form = document.getElementById('deleteSubjectForm');
                            form.action = "/admin/subject/delete/" + subjectId;
                        }
                    </script>
                    <!-- Row ends -->
  ...
  ************* -->
    ...
    <script>
        function setDeleteStudentId(studentId) {
            ...
            form.action = "{{ url('admin/students/delete') }}/" + studentId;
        }
    </script>
</body>
