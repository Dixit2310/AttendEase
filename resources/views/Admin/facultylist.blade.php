                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{ route('faculty_add') }}" class="btn btn-primary ms-auto">Add Faculty</a>
                        </div>
                        <div class="card-body">
                            <!-- Success Message -->
                            @if(session('success'))
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-inline-flex gap-1">
                                                    <!-- Delete Button -->
                                                    <form action="{{ route('faculty_delete', $faculty->faculty_id) }}" method="POST">
                                                        @csrf
                                                        <button type="submit" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete this faculty?')">
                                                            <i class="ri-delete-bin-line"></i>
                                                        </button>
                                                    </form>

                                                    <!-- Edit Button -->
                                                    <a href="{{ route('faculty_edit', $faculty->faculty_id) }}" class="btn btn-outline-success btn-sm">
                                                        <i class="ri-edit-box-line"></i>
                                                    </a>

                                                    <!-- View Button -->
                                                    <a href="{{ route('faculty_view', $faculty->faculty_id) }}" class="btn btn-outline-info btn-sm">
