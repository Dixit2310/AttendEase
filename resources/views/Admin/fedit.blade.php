                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Row starts -->
                                    <form action="{{ route('admin.faculty.update', $faculty->faculty_id) }}"
                                        method="POST">

                                        @csrf
                                        <input type="hidden" name="_method" value="POST">
                                        <!-- Using POST explicitly -->
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date"
                                                        ...
                                                        value="{{ old('date_of_birth', $faculty->date_of_birth) }}"
                                                        required>
                                                    @error('date_of_birth')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control @error('gender') is-invalid @enderror"
                                                        ...
                                                        <option value="Male"
                                                            {{ old('gender', $faculty->gender) == 'Male' ? 'selected' : '' }}>
                                                            Male</option>
                                                        <option value="Female"
                                                            {{ old('gender', $faculty->gender) == 'Female' ? 'selected' : '' }}>
                                                            Female</option>
                                                        <option value="Other"
                                                            {{ old('gender', $faculty->gender) == 'Other' ? 'selected' : '' }}>
                                                            Other</option>
                                                    </select>
                                                    @error('gender')
                                                        <div class="invalid-feedback">{{ $message }}</div>
