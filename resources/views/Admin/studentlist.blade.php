                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="{{ url('student_add') }}" class="btn btn-primary ms-auto">Add Students</a>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="basicExample" class="table truncate m-0 align-middle">
                                            ...
                                            <tbody>
                                                @foreach ($students as $index => $student)
                                                    <tr>
                                                        <td>{{ $loop->iteration }}</td> <!-- ID starts from 1 -->
                                                        ...
                                                        <td>
                                                            <div class="d-inline-flex gap-1">
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    onclick="setDeleteStudentId({{ $student->studentlist_id }})">
                                                                    <i class="ri-delete-bin-line"></i>
                                                                </button>
                                                                <a href="{{ route('student_edit', ['id' => $student->studentlist_id]) }}"
                                                                    class="btn btn-outline-success btn-sm">
                                                                    <i class="ri-edit-box-line"></i>
                                                                </a>
                                                                {{-- <a href="{{ route('profile.view', ['id' => $student->studentlist_id]) }}"
