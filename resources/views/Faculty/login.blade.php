            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-xs-12">
                    <div class="login">
                        ...
                        <form method="POST" action="{{ route('flogin.authenticate') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="faculty_code" name="faculty_code"
                                    ...
                                    value="{{ old('faculty_code') }}" required />
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="password" id="faculty_password" name="faculty_password"
                                    class="form-control @error('faculty_password') is-invalid @enderror" required />
                            </div>
                        ...
                        <p>Don't have an account? <a href="{{ url('faculty.verify') }}">Verify Now</a></p>
                    </div>
                </div>
                <!--- END COL -->
            </div>
