                ...
                <div class="col-lg-6 offset-lg-3 col-xs-12">
                    ...
                    @if (!isset($faculty))
                        <div class="login">
                            ...
                            <form method="POST" action="{{ route('fverify.enrollment') }}">
                                @csrf
                                <div class="form-group">
                                    <label for="">Enrollment Number</label>
                                    <input type="text" id="faculty_code" class="form-control requiredField input-label"
                                        name="faculty_code" required />
                                </div>
