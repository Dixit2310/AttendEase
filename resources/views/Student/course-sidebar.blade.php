...
<html lang="en">
  <head>
    ...
    <!-- SITE TITLE -->
    <title>AttendEase HTML Template</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="single-top-contact">
              ...
              <h4>
                <a
                  href="https://wphtml.com/cdn-cgi/l/email-protection#fa9f829b978a969fba9d979b9396d4999597"
                  ><span
                    class="__cf_email__"
                    data-cfemail="64011c05091408012409050d084a070b09"
          ...
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="top_social_profile">
              <ul>
                ...
                <li>
                  <a href="#" class="top_f_twitter"
                    ><i class="fa fa-twitter" title="Twitter"></i
                  ></a>
                </li>
                <li>
                  <a href="#" class="top_f_instagram"
                    ><i class="fa fa-instagram" title="Instagram"></i
                  ></a>
                </li>
                <li>
                  <a href="#" class="top_f_linkedin"
                ...
                <ul>
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <a class="nav-link" href="index_2.html">Home 02</a>
                      </li>
                      <li>
                        <a class="nav-link" href="index_3.html">Home 03</a>
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <a class="nav-link" href="team.html">Instructor</a>
                      </li>
                      <li>
                        <a class="nav-link" href="team-details.html"
                      ...
                      <li>
                        <a class="nav-link" href="event_single.html"
                          >Event Single</a
                        >
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        <a class="nav-link" href="course.html">Courses 01</a>
                      </li>
                      <li>
                        <a class="nav-link" href="course2.html">Courses 02</a>
                      </li>
                      <li>
                        <a class="nav-link" href="course3.html">Courses 03</a>
                      </li>
                      <li>
                        <a class="nav-link" href="course-sidebar.html"
                          >Course Sidebar</a
                        >
                      </li>
                      <li>
                        <a class="nav-link" href="single_course.html"
                          >Course details</a
                        >
                      </li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <a class="nav-link" href="single_shop.html"
                          >Single Shop</a
                        >
                      </li>
                      <li>
                        <a class="nav-link" href="cart.html">Cart Page</a>
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        <a class="nav-link" href="blog.html">Blog List</a>
                      </li>
                      <li>
                        <a class="nav-link" href="blog_single.html"
                          >Single Blog</a
                        >
                      </li>
                    </ul>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar-post">
              ...
              <div class="single_rat">
                <input type="checkbox" />
                <a href="#"
                  ><img src="assets/images/icon/rating-1.svg" alt=""
                /></a>
              </div>
              <!-- END SINGLE LANGU -->
              <div class="single_rat">
                <input type="checkbox" />
                <a href="#"
                  ><img src="assets/images/icon/rating-2.svg" alt=""
                /></a>
              </div>
              <!-- END SINGLE LANGU -->
              <div class="single_rat">
                <input type="checkbox" />
                <a href="#"
                  ><img src="assets/images/icon/rating-3.svg" alt=""
                /></a>
              </div>
              <!-- END SINGLE LANGU -->
              <div class="single_rat">
                <input type="checkbox" />
                <a href="#"
                  ><img src="assets/images/icon/rating-4.svg" alt=""
                /></a>
              </div>
              <!-- END SINGLE LANGU -->
              <div class="single_rat">
                <input type="checkbox" />
                <a href="#"
                  ><img src="assets/images/icon/rating-5.svg" alt=""
                /></a>
              </div>
              <!-- END SINGLE LANGU -->
            </div>
